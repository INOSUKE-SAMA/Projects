...
import razorImg from '../assets/Razor.jpg'

const Home = () => {
  return (
    <div className='bg-black text-white text-center py-16'>
      <img src={razorImg} alt="" className='mx-auto mb-8 w-48 h-48 rounded-full object-cover transform transition-transform duration-300 hover:scale-105 '/>
      <h1 className='text-4xl font-bold'>
        I'm {" "}
        <span className='text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500'>Inouske-sama</span>,
